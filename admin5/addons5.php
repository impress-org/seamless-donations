...
//// ADDONS - MENU ////
function seamless_donations_admin5_addons_menu() {
    $args = array(
    ...
    seamless_donations_admin5_addons_section_data($addon_options);

    do_action('seamless_donations_tab_addons_after', $addon_options);
}

add_action('cmb2_admin_init', 'seamless_donations_admin5_addons_menu');
...
//// ADDONS - SECTION - DATA ////
function seamless_donations_admin5_addons_section_data($section_options) {
