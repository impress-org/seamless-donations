...
//// FORM OPTIONS - SETUP ////
function seamless_donations_admin5_forms_menu() {
    $args = array(
    ...
    seamless_donations_admin5_forms_levels_section_data($forms_options);
    do_action('seamless_donations_tab_forms_after_levels', $forms_options);

    seamless_donations_admin5_forms_styles_section_data($forms_options);
    seamless_donations_admin5_forms_defaults_section_data($forms_options);
    seamless_donations_admin5_forms_fields_section_data($forms_options);
    seamless_donations_admin5_forms_tweaks_section_data($forms_options);

    do_action('seamless_donations_tab_forms_after', $forms_options);
}

/// set up the hook to load the admin page
add_action('cmb2_admin_init', 'seamless_donations_admin5_forms_menu'); // this builds the page

//// FORM OPTIONS - SECTION - GIVING LEVELS ////
function seamless_donations_admin5_forms_levels_section_data($section_options) {
    // init values
...
function seamless_donations_admin5_forms_styles_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_forms_preload'; // setup the preload handler function
...
function seamless_donations_admin5_forms_defaults_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_forms_preload'; // setup the preload handler function
...
function seamless_donations_admin5_forms_fields_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_forms_preload'; // setup the preload handler function
...
function seamless_donations_admin5_forms_tweaks_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_forms_preload'; // setup the preload handler function
