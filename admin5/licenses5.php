...
//// LICENSES - MENU ////
function seamless_donations_admin5_licenses_menu() {
    $args = array(
    ...
    seamless_donations_admin5_licenses_section_data($licenses_options);

    do_action('seamless_donations_tab_licenses_after', $licenses_options);
}

add_action('cmb2_admin_init', 'seamless_donations_admin5_licenses_menu');

//// LICENSES - SECTION - TEST ////
function seamless_donations_admin5_licenses_section_data($section_options) {
