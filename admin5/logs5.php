...
//// LOGS - MENU ////
function seamless_donations_admin5_logs_menu() {
    $args = array(
    ...
    seamless_donations_admin5_logs_section_ssl($log_options);
    seamless_donations_admin5_logs_section_data($log_options);

    do_action('seamless_donations_tab_logs_after', $log_options);
}

add_action('cmb2_admin_init', 'seamless_donations_admin5_logs_menu');

//// LOGS - SECTION - DATA ////
function seamless_donations_admin5_logs_section_ssl($section_options) {
...
//// LOGS - SECTION - DATA ////
function seamless_donations_admin5_logs_section_data($section_options) {
    $section_options->add_field(array(
