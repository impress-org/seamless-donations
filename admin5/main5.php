...
//// MAIN - MENU ////
function seamless_donations_admin5_main_menu() {
    $args = array(
    ...
    seamless_donations_cmb2_remove_primary_save_button();
    ...
    seamless_donations_admin5_main_section_data($main_options);
...
add_action('cmb2_admin_init', 'seamless_donations_admin5_main_menu');
...
//// MAIN - SECTION - DATA ////
function seamless_donations_admin5_main_section_data($section_options) {
