...
//// SETTINGS - MENU ////
function seamless_donations_admin5_settings_menu() {
    $args = array(
    ...
    seamless_donations_admin5_settings_basics_section_data($settings_options);
    ...
    seamless_donations_admin5_settings_paypal_section_data($settings_options);
    seamless_donations_admin5_settings_stripe_section_data($settings_options);

    //do_action('seamless_donations_tab_settings_before_host', $settings_options);

    seamless_donations_admin5_settings_host_section_data($settings_options);

    do_action('seamless_donations_tab_settings_before_tweaks', $settings_options);

    seamless_donations_admin5_tweaks_section_data($settings_options);
    seamless_donations_admin5_debug_section_data($settings_options);

    do_action('seamless_donations_tab_settings_after', $settings_options);
}

/// set up the hook to load the admin page
add_action('cmb2_admin_init', 'seamless_donations_admin5_settings_menu');

//// SETTINGS - SECTION - NOTIFICATION EMAIL ////
function seamless_donations_admin5_settings_basics_section_data($section_options) {
    // init values
...
function seamless_donations_admin5_settings_paypal_section_data($section_options) {
    // init values
...
function seamless_donations_admin5_settings_stripe_section_data($section_options) {
    // init values
    $payment_processor = get_option('dgx_donate_payment_processor_choice');
...
function seamless_donations_admin5_settings_host_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_settings_preload'; // setup the preload handler function
...
function seamless_donations_admin5_tweaks_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_settings_preload'; // setup the preload handler function
...
function seamless_donations_admin5_debug_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_settings_preload'; // setup the preload handler function
