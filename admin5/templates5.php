...
//// TEMPLATES - MENU ////
function seamless_donations_admin5_templates_menu() {
    $args = array(
    ...
    seamless_donations_admin5_templates_test_section_data($template_options);
    seamless_donations_admin5_templates_section_data($template_options);

    do_action('seamless_donations_tab_templates_after', $template_options);
}

add_action('cmb2_admin_init', 'seamless_donations_admin5_templates_menu');

//// TEMPLATES - SECTION - TEST ////
function seamless_donations_admin5_templates_test_section_data($section_options) {
    // init values
...
function seamless_donations_admin5_templates_section_data($section_options) {
    // init values
    $handler_function = 'seamless_donations_admin5_templates_preload'; // setup the preload handler function
