...
//// THANK YOU - MENU ////
function seamless_donations_admin5_thanks_menu() {
    $args = array(
    ...
    seamless_donations_admin5_thanks_section_data($thanks_options);

    do_action('seamless_donations_tab_forms_after', $thanks_options);
}

add_action('cmb2_admin_init', 'seamless_donations_admin5_thanks_menu');

//// THANK YOU - SECTION - DATA ////
function seamless_donations_admin5_thanks_section_data($section_options) {
    // init values
