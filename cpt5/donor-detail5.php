...
function seamless_donations_cpt_donor_detail_init() {
    $args = array(
        'id'           => 'seamless_donations_cpt_donors5_metabox',
    ...
    seamless_donations_cpt_donors5_section_data($template_options);
...
///
function seamless_donations_cpt_donors5_section_data($section_options) {
    ...
    $section_options->add_field(array(
        ...
        'id'          => 'seamless_donations_cpt_donor5_data',
        'type'        => 'title',
        'after_field' => $html,
    ));
    ...
    $section_options->add_field(array(
        ...
        'id'          => 'seamless_donations_cpt_donor5_data_more',
        'type'        => 'title',
        'after_field' => $html,
    ));
}
