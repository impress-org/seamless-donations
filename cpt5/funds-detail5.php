...
function seamless_donations_cpt_funds_detail_init() {
	...
	add_action( 'pre_post_update', 'seamless_donations_cpt_funds_process_buttons', 10, 2 );
...
///
function seamless_donations_cpt_funds_process_buttons( $post_id, $data ) {
	...
	if ( isset( $_POST["_dgx_donate_fund_show"] ) ) {
		if ( $_POST["_dgx_donate_fund_show"] != 'yes' ) {
			$_POST["_dgx_donate_fund_show"] = 'No';
		} else {
			$_POST["_dgx_donate_fund_show"] = 'Yes';
		}
	}
