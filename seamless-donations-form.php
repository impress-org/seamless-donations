...
function seamless_donations_generate_donation_form() {
    ...
    if ($form_style != 'classic' and $form_style != 'none') {
        ...
        $repeating_section                     = array(
            'elements' => array(
                '_dgx_donate_repeating' => array(
                    ...
                    'prompt' => esc_html__(
                        "I would like this donation to repeat each month", 'seamless-donations'),
                    'before' => '<p>',
                    'after'  => '</p>',
                ),
            ),
    ...
    if ($show_donor_employer_field != 'false') {
        ...
        if ($show_employer_match_checkbox != 'false') {
            $donor_section['elements']['_dgx_donate_employer_match'] = array(
                'type'   => 'checkbox',
                'prompt' => esc_html__(
                    "My employer matches donations", 'seamless-donations'),
                'before' => '<P>',
                'after'  => '</P>',
            );
        }
...
function seamless_donations_get_billing_section() {
    ...
    } else $billing_section['elements']['_dgx_donate_donor_state']['class'] = '';
    ...
    } else $billing_section['elements']['_dgx_donate_donor_zip']['class'] = '';
